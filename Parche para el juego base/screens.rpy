    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            if persistent.language == "english":
                    if renpy.android:
                        text _("Android Version by: just6889 | President of {a=https://traduction-club.live/}Traduction Club!{/a}") xalign .5
                        null height 35
                        text _("")
            ...
            # spanish credits
                ...
                null height 1
                text _("Encuentra más traducciones en {a=https://traduction-club.live/}nuestra página web{/a} (click aquí).") xalign .5
                null height 10
                text _("Más creditos de traductores aquí...") xalign .5
                null height 10
            ...
            text _(" ")
            text _("Music by {a=https://aleksis-tristan-shaw.itch.io}Aleksis Tristan Shaw{/a} and {a=https://makotohiramatsu.itch.io}Makoto Hiramatsu{/a}, used under a Creative Commons Attribution 4.0 International (CC BY 4.0) license.")
            text _(" ")
