# TODO: Translation updated at 2025-03-12 11:26
...
translate spanish strings:
    ...
    new "Abrir traceback.txt en un editor de texto."
    ...
    new "Copiar traceback.txt al portapapeles como BBcode para foros como https://lemmasoft.renai.us/."
    ...
    new "Copia traceback.txt al portapapeles como Markdown para Discord."
    ...
    old "Rollback"
    new "Regresar en el tiempo" # yo se que no es esto pero dejemoslo por las risas para la pantalla de errores de renpy XDDDD

    # renpy/common/_errorhandling.rpym:741
    old "Attempts a roll back to a prior time, allowing you to save or choose a different choice."
    new "Intenta un viaje al pasado, permitiéndote guardar o elegir una opción diferente." # tambien deja esto por favor XD
    ...
    new "Ignora el error, permitiéndote continuar."

    # renpy/common/_errorhandling.rpym:750
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Ignora el error, permitiéndote continuar. Esto a menudo lleva a errores adicionales."
    ...
    new "Abre la consola para permitir la depuración del problema."
